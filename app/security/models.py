...
from neumscan.utils import valida_cedula , phone_regex
...
class User(AbstractUser):
    ...
    groups = models.ManyToManyField(
        ...
        related_name="security_user_groups",  # Unique related_name
    ...
    user_permissions = models.ManyToManyField(
        ...
        related_name="security_user_permissions",  # Unique related_name
        related_query_name="user",
    )
    ...
    def get_image(self):
        if self.image:
            ...
            return '/static/img/customer01.jpg'
    def is_admin(self):
        ...
        if is_new:
            ...
            if self.is_superuser:
                try:
                    ...
                    print(f"Warning: 'Administrador' group not found. Cannot assign to superuser {self.username}.")
                    pass # Or raise an error, or create the group if appropriate
